import { LOCATION_CREATED, LOCATIONS_FETCHED, PROJECT_ID_REQUIRED, PROJECT_LOCATIONS } from "../constants/appMessages";
import { location, LocationTable } from "../database/schemas/location";
